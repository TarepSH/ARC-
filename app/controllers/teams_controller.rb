...
@line_race_teams = Team.where(team_category: "Line Race").order(team_group: :asc, team_point: :desc, best_time: :asc)
@open_sumo_teams = Team.where(team_category: "Sumo").order(team_group: :asc, team_point: :desc, best_time: :asc)
